            ...
            <div className="flex h-full flex-col gap-4">
              ...
              <div className="flex-1 overflow-auto py-4">
                <nav className="flex flex-col gap-1 px-4">
                  <MobileNavLink href="/admin/home" icon={<Home className="h-4 w-4" />} label="Home" onClick={() => setIsOpen(false)} />
                  <MobileNavLink href="/admin/posts" icon={<MessageCircle className="h-4 w-4" />} label="Manage Post" onClick={() => setIsOpen(false)} />
                  <LogoutButton />
                </nav>
              </div>
